...
CREATE TABLE IF NOT EXISTS "signatures"(
  "transactionId" VARCHAR(33) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "delegates"(
  ...
  "transactionId" VARCHAR(33) NOT NULL,
  FOREIGN KEY("transactionId") REFERENCES "trs"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "forks_stat"(
  ...
  "previousBlock" VARCHAR(33) NOT NULL,
  "cause" INT NOT NULL
);
